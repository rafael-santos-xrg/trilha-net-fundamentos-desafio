namespace DesafioFundamentos.Models
{
    public class Estacionamento
    {
        ...
        public void AdicionarVeiculo()
        {
            ...
            Console.WriteLine($"Carro de placa {veiculo} adicionado ao nosso sistema e já pode estacionar!");
        }
        ...
        public void RemoverVeiculo()
        {
            ...
            if (placa != null && _veiculos.Any(veiculo => veiculo.ToUpper() == placa.ToUpper()))
            {
